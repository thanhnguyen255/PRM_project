...
class SubmitPreEvidenceScreen extends StatefulWidget {
  final int activityId;
  const SubmitPreEvidenceScreen({super.key, required this.activityId});

  @override
  State<SubmitPreEvidenceScreen> createState() => _SubmitPreEvidenceScreenState();
}

class _SubmitPreEvidenceScreenState extends State<SubmitPreEvidenceScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (err == null) {
      ...
      Navigator.pop(context); // Trở về màn hình chi tiết
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Nộp bài / Bằng chứng')),
